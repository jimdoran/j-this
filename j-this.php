	...
	case 'photo_js': ?>
		...
		function pick(img, desc) {
			if (img) {
				...
				jQuery('.photolist').append('<input name="photo_description[' + length + ']" value="' + desc +'" type="hidden"/>'); <?php /* JLD removed <p> and <a>, which I never use */ ?>
				insert_editor( "\n\n" + encodeURI('<img src="' + img +'" alt="' + desc + '" />'));
			}
			return false;
		}
